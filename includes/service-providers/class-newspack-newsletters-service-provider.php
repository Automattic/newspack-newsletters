...
%3$s
	 ...
	 *     'trigger_prefix' => string  // Legacy ESP-native autocomplete trigger preserved for muscle memory (e.g. "*|" for Mailchimp). Leave empty to opt out; the universal "{}" picker trigger always works.
